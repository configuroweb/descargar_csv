...
<body>
	...
	<div class="col-md-6 well">
		<h3 class="text-primary">Generar Archivo CSV</h3>
		...
		<a href="export.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-export"></span> Exportar Tabla como CSV</a>
		<br /><br />
